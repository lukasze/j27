  ...
  return (
    <div>
      <h2 id="u-nrepresentative-heading" data-cy="UNrepresentativeHeading">
        <Translate contentKey="j27App.uNrepresentative.home.title">U Nrepresentatives</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="j27App.uNrepresentative.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="j27App.uNrepresentative.home.createLabel">Create new U Nrepresentative</Translate>
          </Link>
        </div>
      </h2>
        ...
        {uNrepresentativeList && uNrepresentativeList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="j27App.uNrepresentative.id">Id</Translate>
                </th>
                <th>
                  <Translate contentKey="j27App.uNrepresentative.name">Name</Translate>
                </th>
                <th>
                  <Translate contentKey="j27App.uNrepresentative.gender">Gender</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="j27App.uNrepresentative.home.notFound">No U Nrepresentatives found</Translate>
            </div>
          )
        )}
      </div>
