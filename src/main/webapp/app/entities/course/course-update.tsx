  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="j27App.course.home.createOrEditLabel" data-cy="CourseCreateUpdateHeading">
            <Translate contentKey="j27App.course.home.createOrEditLabel">Create or edit a Course</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              {!isNew ? (
                <ValidatedField
                  ...
                  readOnly
                  id="course-id"
                  label={translate('j27App.course.id')}
                  validate={{ required: true }}
                />
              ) : null}
              <ValidatedField label={translate('j27App.course.teacher')} id="course-teacher" name="teacher" data-cy="teacher" type="text" />
