  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="j27App.student.home.createOrEditLabel" data-cy="StudentCreateUpdateHeading">
            <Translate contentKey="j27App.student.home.createOrEditLabel">Create or edit a Student</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              {!isNew ? (
                <ValidatedField
                  ...
                  readOnly
                  id="student-id"
                  label={translate('j27App.student.id')}
                  validate={{ required: true }}
                />
              ) : null}
              <ValidatedField label={translate('j27App.student.name')} id="student-name" name="name" data-cy="name" type="text" />
              <ValidatedField
                label={translate('j27App.student.course')}
                id="student-course"
                data-cy="course"
                type="select"
                multiple
