  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="j27App.car.home.createOrEditLabel" data-cy="CarCreateUpdateHeading">
            <Translate contentKey="j27App.car.home.createOrEditLabel">Create or edit a Car</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              {!isNew ? (
                <ValidatedField name="id" required readOnly id="car-id" label={translate('j27App.car.id')} validate={{ required: true }} />
              ) : null}
              <ValidatedField label={translate('j27App.car.brand')} id="car-brand" name="brand" data-cy="brand" type="text" />
              <ValidatedField label={translate('j27App.car.model')} id="car-model" name="model" data-cy="model" type="text" />
